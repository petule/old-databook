...
ActiveRecord::Schema.define(version: 20170612224424) do
  ...
  create_table "categories", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_categories_on_category_id_id"
  ...
  create_table "dph_product_types", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "dph_id"
  ...
  create_table "dphs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "val"
    t.integer "position"
    t.boolean "pub"
    t.bigint "language_id"
  ...
  create_table "menu_objects", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "menu_id"
    t.integer "object_id"
  ...
  create_table "product_cols", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "col"
    t.string "title"
